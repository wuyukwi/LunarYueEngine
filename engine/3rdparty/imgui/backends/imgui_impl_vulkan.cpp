        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
                ...
                if (sizeof(ImTextureID) < sizeof(ImU64))
                {
                    ...
                    IM_ASSERT(pcmd->TextureId == (ImTextureID)bd->DescriptorSet);
                    desc_set[0] = bd->DescriptorSet;
                }
...
bool ImGui_ImplVulkan_CreateFontsTexture(VkCommandBuffer command_buffer)
{
    ...
    bd->DescriptorSet = (VkDescriptorSet)ImGui_ImplVulkan_AddTexture(bd->FontSampler, bd->FontView, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
