...
namespace LunarYue::UI::Internal
{
	...
	*/
	...
	public:
		...
		*/
		std::vector<std::pair<LunarYue::UI::Widgets::AWidget*, Internal::EMemoryMode>>& GetWidgets();

	protected:
		std::vector<std::pair<LunarYue::UI::Widgets::AWidget*, Internal::EMemoryMode>> m_widgets;
