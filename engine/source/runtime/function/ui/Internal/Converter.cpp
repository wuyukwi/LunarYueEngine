...
ImVec4 LunarYue::UI::Internal::Converter::ToImVec4(const Types::Color& p_value) { return ImVec4(p_value.r, p_value.g, p_value.b, p_value.a); }

LunarYue::UI::Types::Color LunarYue::UI::Internal::Converter::ToColor(const ImVec4& p_value)
{
