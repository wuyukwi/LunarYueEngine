...
LunarYue::UI::Panels::PanelWindow::PanelWindow(const std::string&                   p_name,
                                               bool                                 p_opened,
                                               const Settings::PanelWindowSettings& p_floatingPanelSettings) :
    name(p_name),
    resizable(p_floatingPanelSettings.resizable), closable(p_floatingPanelSettings.closable), movable(p_floatingPanelSettings.movable),
    scrollable(p_floatingPanelSettings.scrollable), dockable(p_floatingPanelSettings.dockable),
...
void LunarYue::UI::Panels::PanelWindow::Open()
{
    if (!m_opened)
    {
        m_opened = true;
...
void LunarYue::UI::Panels::PanelWindow::Close()
{
    if (m_opened)
    {
        m_opened = false;
...
void LunarYue::UI::Panels::PanelWindow::Focus() { ImGui::SetWindowFocus((name + m_panelID).c_str()); }

void LunarYue::UI::Panels::PanelWindow::SetOpened(bool p_value)
{
    if (p_value != m_opened)
    {
        m_opened = p_value;
...
bool LunarYue::UI::Panels::PanelWindow::IsOpened() const { return m_opened; }

bool LunarYue::UI::Panels::PanelWindow::IsHovered() const { return m_hovered; }

bool LunarYue::UI::Panels::PanelWindow::IsFocused() const { return m_focused; }

bool LunarYue::UI::Panels::PanelWindow::IsAppearing() const
{
...
void LunarYue::UI::Panels::PanelWindow::ScrollToBottom() { m_mustScrollToBottom = true; }

void LunarYue::UI::Panels::PanelWindow::ScrollToTop() { m_mustScrollToTop = true; }

bool LunarYue::UI::Panels::PanelWindow::IsScrolledToBottom() const { return m_scrolledToBottom; }

bool LunarYue::UI::Panels::PanelWindow::IsScrolledToTop() const { return m_scrolledToTop; }

void LunarYue::UI::Panels::PanelWindow::_Draw_Impl()
{
    if (m_opened)
    {
