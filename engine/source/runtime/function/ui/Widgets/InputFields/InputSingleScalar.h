...
namespace LunarYue::UI::Widgets::InputFields
{
    ...
    public:
        ...
        InputSingleScalar(ImGuiDataType      p_dataType,
            ...
            DataWidget<T>(value),
            m_dataType(p_dataType), value(p_defaultValue), step(p_step), fastStep(p_fastStep), label(p_label), format(p_format),
    ...
    public:
        ...
        LunarYue::Eventing::Event<T> ContentChangedEvent;
        LunarYue::Eventing::Event<T> EnterPressedEvent;
