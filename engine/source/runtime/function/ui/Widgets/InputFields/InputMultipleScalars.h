...
namespace LunarYue::UI::Widgets::InputFields
{
    ...
    public:
        ...
        InputMultipleScalars(ImGuiDataType      p_dataType,
            ...
            m_dataType(p_dataType), step(p_step), fastStep(p_fastStep), label(p_label), format(p_format), selectAllOnClick(p_selectAllOnClick)
        {
    ...
    protected:
        void _Draw_Impl() override
        {
            ...
            bool enterPressed = ImGui::InputScalarN((label + this->m_widgetID).c_str(),
                                                    m_dataType,
                                                    values.data(),
                                                    _Size,
