...
LunarYue::UI::Widgets::InputFields::InputInt::InputInt(int p_defaultValue, int p_step, int p_fastStep, const std::string & p_label, const std::string & p_format, bool p_selectAllOnClick)
