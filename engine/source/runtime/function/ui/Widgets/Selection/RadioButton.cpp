...
LunarYue::UI::Widgets::Selection::RadioButton::RadioButton(bool p_selected, const std::string & p_label) :
...
bool LunarYue::UI::Widgets::Selection::RadioButton::IsSelected() const
{
	return m_selected;
}

bool LunarYue::UI::Widgets::Selection::RadioButton::GetRadioID() const
{
	return m_radioID;
}
