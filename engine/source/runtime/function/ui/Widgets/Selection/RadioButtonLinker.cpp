...
#include "function/ui/Widgets/Selection/RadioButtonLinker.h"

LunarYue::UI::Widgets::Selection::RadioButtonLinker::RadioButtonLinker() : DataWidget<int>(m_selected)
{
}

void LunarYue::UI::Widgets::Selection::RadioButtonLinker::Link(RadioButton& p_radioButton)
{
...
{
	auto it = std::find_if(m_radioButtons.begin(), m_radioButtons.end(), [&p_radioButton](std::pair<LunarYue::Eventing::ListenerID, std::reference_wrapper<RadioButton>>& p_pair)
	{
...
int LunarYue::UI::Widgets::Selection::RadioButtonLinker::GetSelected() const
{
	return m_selected;
}

void LunarYue::UI::Widgets::Selection::RadioButtonLinker::_Draw_Impl()
{
	// The RadioButtonLinker is special, it has nothing to display :)
}

void LunarYue::UI::Widgets::Selection::RadioButtonLinker::OnRadioButtonClicked(int p_radioID)
{
