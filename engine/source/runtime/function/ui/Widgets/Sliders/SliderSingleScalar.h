...
#include "function/ui/Widgets/Sliders/ESliderOrientation.h"
...
namespace LunarYue::UI::Widgets::Sliders
{
    ...
    public:
        ...
        SliderSingleScalar(ImGuiDataType      p_dataType,
            ...
            DataWidget<T>(value),
            m_dataType(p_dataType), min(p_min), max(p_max), value(p_value), orientation(p_orientation), label(p_label), format(p_format)
        {}
        ...
        void _Draw_Impl() override
        {
            ...
            switch (orientation)
            {
                ...
                case ESliderOrientation::VERTICAL:
                    valueChanged = ImGui::VSliderScalar((label + this->m_widgetID).c_str(),
                                                        Internal::Converter::ToImVec2(verticalModeSize),
                                                        m_dataType,
                                                        &value,
                                                        &min,
                                                        &max,
