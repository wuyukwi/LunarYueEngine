...
namespace LunarYue
{
    ...
    void Character::setObject(std::shared_ptr<Object> gobject)
    {
        ...
        if (m_character_object)
        {
            const TransformComponent* transform_component = m_character_object->getComponent<TransformComponent>();
    ...
    void Character::tick(float delta_time)
    {
        ...
        TransformComponent* transform_component = m_character_object->getComponent<TransformComponent>();
        ...
        const MotorComponent* motor_component = m_character_object->getComponent<MotorComponent>();
    ...
    {
        CameraComponent* camera_component = m_character_object->getComponent<CameraComponent>();
