...
namespace LunarYue
{
    ...
    void ParticlePass::setupAttachments()
    {
        ...
        // LunarYue texture
        {
            std::shared_ptr<TextureData> m_LunarYue_logo_texture_resource = m_render_resource->loadTexture(
                m_particle_manager->getGlobalParticleRes().m_LunarYue_logo_texture_path, true);
