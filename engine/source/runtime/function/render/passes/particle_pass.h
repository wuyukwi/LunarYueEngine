...
namespace LunarYue
{
    ...
    private:
        ...
        RHIImage*     m_LunarYue_logo_texture_image      = nullptr;
        RHIImageView* m_LunarYue_logo_texture_image_view = nullptr;
        VmaAllocation m_LunarYue_logo_texture_vma_allocation;
