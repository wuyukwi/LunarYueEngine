...
namespace LunarYue
{
    enum class LunarYue_IMAGE_TYPE : uint8_t
    {
        LunarYue_IMAGE_TYPE_UNKNOWM = 0,
        LunarYue_IMAGE_TYPE_2D
    };
    ...
    public:
        ...
        LunarYue_IMAGE_TYPE   m_type { LunarYue_IMAGE_TYPE::LunarYue_IMAGE_TYPE_UNKNOWM};
...
template<>
struct std::hash<LunarYue::MeshSourceDesc>
{
    size_t operator()(const LunarYue::MeshSourceDesc& rhs) const noexcept { return rhs.getHashValue(); }
};
template<>
struct std::hash<LunarYue::MaterialSourceDesc>
{
    size_t operator()(const LunarYue::MaterialSourceDesc& rhs) const noexcept { return rhs.getHashValue(); }
};
