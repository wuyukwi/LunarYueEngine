...
REFLECT(mesh::info)
{
    rttr::registration::class_<mesh::info>("info")
        .property_readonly("vertices", &mesh::info::vertices)(rttr::metadata("pretty_name", "Vertices"), rttr::metadata("tooltip", "Vertices count."))
        ...
        .property_readonly("subsets", &mesh::info::subsets)(rttr::metadata("pretty_name", "Subsets"), rttr::metadata("tooltip", "Subsets count."));
}
