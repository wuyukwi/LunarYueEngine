...
{
    rttr::registration::enumeration<probe_type>("probe_type")(rttr::value("box", probe_type::box), rttr::value("sphere", probe_type::sphere));
    rttr::registration::enumeration<reflect_method>("reflect_method")(rttr::value("environment", reflect_method::environment),
    ...
    rttr::registration::class_<reflection_probe::box>("box")
        ...
        .property("transition_distance", &reflection_probe::box::transition_distance)(rttr::metadata("pretty_name", "Transition Distance"));
    rttr::registration::class_<reflection_probe::sphere>("sphere").property("range",
                                                                            &reflection_probe::sphere::range)(rttr::metadata("pretty_name", "Range"));
