...
REFLECT(model)
{
    rttr::registration::class_<model>("model")
        .property("lods", &model::get_lods, &model::set_lods)(rttr::metadata("pretty_name", "LOD"), rttr::metadata("tooltip", "Levels of Detail."))
        .property("lod_limits", &model::get_lod_limits, &model::set_lod_limits)(rttr::metadata("pretty_name", "LOD Ranges"),
                                                                                rttr::metadata("tooltip", "LOD ranges in % of screen."),
                                                                                rttr::metadata("format", "%.0f%%"),
                                                                                rttr::metadata("min", 0),
                                                                                rttr::metadata("max", 100))
        .property("materials", &model::get_materials, &model::set_materials)(rttr::metadata("pretty_name", "Materials"),
        ...
        .property("lod_transition_time", &model::get_lod_transition_time, &model::set_lod_transition_time)(
            rttr::metadata("pretty_name", "Transition Time"), rttr::metadata("tooltip", "Transition time between two levels of detail."))
