...
namespace gfx
{
    ...
    {
        rttr::registration::enumeration<texture_format>("texture_format")(rttr::value("BC1", texture_format::BC1),
        ...
        rttr::registration::class_<texture_info>("texture_info")
            ...
            .property_readonly("storageSize", &texture_info::storageSize)(rttr::metadata("pretty_name", "Storage Size(bytes)"))
