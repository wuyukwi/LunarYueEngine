...
{
    rttr::registration::class_<audio_source_component>("audio_source_component")(rttr::metadata("category", "AUDIO"),
                                                                                 rttr::metadata("pretty_name", "Audio Source"))
        ...
        .property("loop", &audio_source_component::is_looping, &audio_source_component::set_loop)(rttr::metadata("pretty_name", "Loop"))
        ...
        .property("volume_rolloff", &audio_source_component::get_volume_rolloff, &audio_source_component::set_volume_rolloff)(
            rttr::metadata("pretty_name", "Volume Rolloff"), rttr::metadata("min", 0.0f), rttr::metadata("max", 10.0f))
        .property("range", &audio_source_component::get_range, &audio_source_component::set_range)(rttr::metadata("pretty_name", "Range"))
        .property("sound", &audio_source_component::get_sound, &audio_source_component::set_sound)(rttr::metadata("pretty_name", "Sound"));
    ;
}
