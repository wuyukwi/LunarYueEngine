...
{
    rttr::registration::class_<audio_listener_component>("audio_listener_component")(rttr::metadata("category", "AUDIO"),
                                                                                     rttr::metadata("pretty_name", "Audio Listener"))
        .constructor<>()(rttr::policy::ctor::as_std_shared_ptr);
}

SAVE(audio_listener_component) { try_save(ar, cereal::make_nvp("base_type", cereal::base_class<runtime::component>(&obj))); }
...
LOAD(audio_listener_component) { try_load(ar, cereal::make_nvp("base_type", cereal::base_class<runtime::component>(&obj))); }
