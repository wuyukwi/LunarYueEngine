        ...
        axis_swap_path_t(path_t path, axis_t x, axis_t y, axis_t z) :
            transform_path_ {
                ...
                [x, y, z](path_vertex_t& vertex) {
                    vertex.position =
                        gml::dvec3 {vertex.position[static_cast<int>(x)], vertex.position[static_cast<int>(y)], vertex.position[static_cast<int>(z)]};
                    vertex.tangent =
                        gml::dvec3 {vertex.tangent[static_cast<int>(x)], vertex.tangent[static_cast<int>(y)], vertex.tangent[static_cast<int>(z)]};
                    vertex.normal =
                        gml::dvec3 {vertex.normal[static_cast<int>(x)], vertex.normal[static_cast<int>(y)], vertex.normal[static_cast<int>(z)]};
                }}
        {}
