...
box_corner_t::box_corner_t(const gml::dvec3& position, double radius, int slices) :
    translate_mesh_ {{gml::dvec3 {radius, 0.0, 0.0}, gml::dvec3 {0.0, radius, 0.0}, gml::dvec3 {0.0, 0.0, radius}, slices}, position}
{}
...
rounded_box_mesh_t::rounded_box_mesh_t(double radius, const gml::dvec3& size, int slices, const gml::ivec3& segments) :
    merge_mesh_ {{{{size[1], size[2]}, {segments[1], segments[2]}, size[0] + radius}, axis_t::Z, axis_t::X, axis_t::Y},
                 {{{{size[0], size[2]}, {segments[0], segments[2]}, size[1] + radius}, axis_t::X, axis_t::Z, axis_t::Y}, true, false},
