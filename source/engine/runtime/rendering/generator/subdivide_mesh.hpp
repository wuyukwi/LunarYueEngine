...
namespace generator
{
    ...
    public:
        ...
        private:
            ...
            explicit triangles_t(const subdivide_mesh_t& mesh) : mesh_ {&mesh}, i_ {0}, triangles_ {mesh.mesh_.triangles()}, triangle_ {} {}
        ...
        {
        public:
            bool done() const noexcept { return vertex_index_ == mesh_->vertex_cache_.size() && edge_index_ == mesh_->edge_cache_.size(); }
