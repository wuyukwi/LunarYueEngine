...
namespace generator
{
    ...
    private:
        ...
        struct array_wrapper
        {
            ...
            explicit array_wrapper(const gml::dvec3 (&p)[D1][D0]) { std::copy(&p[0][0], &p[0][0] + D1 * D0, &data[0][0]); }
        };
    ...
    public:
        ...
        explicit bezier_mesh_t(const gml::dvec3 (&p)[D1][D0],
                               const gml::ivec2& segments = {16, 16}) : // Work around a msvc lambda capture bug by wrapping the array.
