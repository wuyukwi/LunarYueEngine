...
svg_writer_t::TriangleElem::TriangleElem(const gml::dvec3& p1, const gml::dvec3& p2, const gml::dvec3& p3, const gml::dvec3& color) :
...
svg_writer_t::svg_writer_t(int width, int height) :
    size_ {width, height}, viewMatrix_ {1.0}, projMatrix_ {1.0}, viewProjMatrix_ {1.0}, viewportOrigin_ {0, 0}, viewportSize_ {width, height},
    lightDir_ {1.0, 2.0, 3.0}, cullface_ {true}, elems_ {}
{
...
void svg_writer_t::writeTriangle(const gml::dvec3& p1, const gml::dvec3& p2, const gml::dvec3& p3, const gml::dvec3& color)
{
...
std::string svg_writer_t::str() const
{
    ...
    std::stable_sort(
        elems_.begin(), elems_.end(), [](const std::unique_ptr<BaseElem>& e1, const std::unique_ptr<BaseElem>& e2) { return e1->z_ > e2->z_; });
