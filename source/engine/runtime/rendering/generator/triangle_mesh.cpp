...
triangle_mesh_t::triangles_t triangle_mesh_t::triangles() const noexcept { return triangles_t {*this}; }

triangle_mesh_t::vertices_t triangle_mesh_t::vertices() const noexcept { return vertices_t {*this}; }
