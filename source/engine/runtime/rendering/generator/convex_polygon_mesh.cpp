...
convex_polygon_mesh_t::convex_polygon_mesh_t(std::vector<gml::dvec3> vertices, int segments, int rings) noexcept :
    vertices_ {std::move(vertices)}, segments_ {segments}, rings_ {rings}, center_ {calcCenter(vertices_)}, normal_ {calcNormal(center_, vertices_)},
    tangent_ {}, bitangent_ {}, tex_delta_ {}
{
...
convex_polygon_mesh_t::triangles_t convex_polygon_mesh_t::triangles() const noexcept { return triangles_t {*this}; }

convex_polygon_mesh_t::vertices_t convex_polygon_mesh_t::vertices() const noexcept { return vertices_t {*this}; }
