...
parametric_mesh_t::parametric_mesh_t(const std::function<mesh_vertex_t(const gml::dvec2& t)>& eval, const gml::ivec2& segments) noexcept :
    eval_ {std::move(eval)}, segments_ {segments}, delta_ {1.0 / segments[0], 1.0 / segments[1]}
{}

parametric_mesh_t::triangles_t parametric_mesh_t::triangles() const noexcept { return triangles_t {*this}; }

parametric_mesh_t::vertices_t parametric_mesh_t::vertices() const noexcept { return vertices_t {*this}; }
