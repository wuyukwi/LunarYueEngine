    ...
    public:
        ...
        public:
            ...
            edge_t generate() const
            {
                ...
                if (i_ % 2 == 0)
                    return edge_t {glm::ivec2 {edge_.vertices[0], static_cast<int>(shape_->vertex_cache_.size()) + i_ / 2}};

                return edge_t {glm::ivec2 {static_cast<int>(shape_->vertex_cache_.size()) + i_ / 2, edge_.vertices[1]}};
            }
        ...
        {
        public:
            bool done() const noexcept { return vertex_index_ == shape_->vertex_cache_.size() && edges_.done(); }
        ...
        private:
            ...
            explicit vertices_t(const subdivide_shape_t& shape) : shape_ {&shape}, vertex_index_ {0}, edges_ {shape.shape_.edges()} {}
