...
spherical_triangle_mesh_t::triangles_t::triangles_t(const spherical_triangle_mesh_t& mesh) : mesh_ {&mesh}, row_ {0}, col_ {0}, i_ {0} {}

bool spherical_triangle_mesh_t::triangles_t::done() const noexcept { return row_ == mesh_->segments_; }
...
spherical_triangle_mesh_t::vertices_t::vertices_t(const spherical_triangle_mesh_t& mesh) : mesh_ {&mesh}, row_ {0}, col_ {0} {}

bool spherical_triangle_mesh_t::vertices_t::done() const noexcept { return row_ > mesh_->segments_; }
...
spherical_triangle_mesh_t::spherical_triangle_mesh_t(double radius, int segments) :
    spherical_triangle_mesh_t {gml::dvec3 {radius, 0.0, 0.0}, gml::dvec3 {0.0, radius, 0.0}, gml::dvec3 {0.0, 0.0, radius}, segments}
{}

spherical_triangle_mesh_t::spherical_triangle_mesh_t(const gml::dvec3& v0, const gml::dvec3& v1, const gml::dvec3& v2, int segments) :
    v0_ {v0}, v1_ {v1}, v2_ {v2}, normal_ {gml::normal(v0, v1, v2)}, segments_ {segments}
{}

spherical_triangle_mesh_t::triangles_t spherical_triangle_mesh_t::triangles() const noexcept { return triangles_t {*this}; }

spherical_triangle_mesh_t::vertices_t spherical_triangle_mesh_t::vertices() const noexcept { return vertices_t {*this}; }
