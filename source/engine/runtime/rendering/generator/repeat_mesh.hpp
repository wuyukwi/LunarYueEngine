...
namespace generator
{
    ...
    public:
        ...
        private:
            ...
            friend int count(const triangles_t& generator) noexcept { return generator.counttriangles_t(); }
        ...
        explicit repeat_mesh_t(mesh_t mesh, int instances, const gml::dvec3& delta) noexcept :
            mesh_ {std::move(mesh)}, instances_ {instances}, delta_ {delta}, vertex_count_ {count(mesh_.vertices())}
        {}
