...
const std::vector<math::transform>& model_component::get_bone_transforms() const { return bone_transforms_; }
...
const std::vector<runtime::entity>& model_component::get_bone_entities() const { return bone_entities_; }
