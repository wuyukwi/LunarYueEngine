...
namespace runtime
{
    ...
    public:
        ...
        bool operator==(const entity& other) const { return other.manager_ == manager_ && other.id_ == id_; }
    ...
    public:
        ...
        /// </summary>
        //-----------------------------------------------------------------------------
        bool is_touched() const { return last_touched_ == static_cast<std::uint32_t>(ecs::get_frame()) - 1; }
    ...
    public:
        ...
        static rtti::type_index_sequential_t::index_t static_id() { return rtti::type_index_sequential_t::id<component, T>(); }
    ...
    public:
        ...
        public:
            struct unpacker
            {
                explicit unpacker(chandle<Components>&... handles) : handles(std::tuple<chandle<Components>&...>(handles...)) {}
            ...
            {
            public:
                iterator_type(entity_component_system* manager, const component_mask_t mask, std::uint32_t index, const unpacker& unpacker) :
...
namespace std
{
    ...
    {
        std::size_t operator()(const runtime::entity& entity) const { return static_cast<std::size_t>(entity.id().index() ^ entity.id().version()); }
    };
} // namespace std
