...
#define TL_OPTIONAL_IS_TRIVIALLY_COPY_CONSTRUCTIBLE(T) hpp::hpp_detail::is_trivially_copy_constructible<T>::value
...
// in some cases. This is a check to workaround the common failing case.
        ...
        struct invoke_result_impl<F, decltype(hpp_detail::invoke(std::declval<F>(), std::declval<Us>()...), void()), Us...>
        {
        ...
        struct is_swappable<T[N], T[N]>
            : std::integral_constant<bool,
                                     decltype(hpp_detail::swap_adl_tests::can_swap<T[N], T[N]>(0))::value &&
                                         (!decltype(hpp_detail::swap_adl_tests::uses_std<T[N], T[N]>(0))::value || is_swappable<T, T>::value)>
        {};

        template<class T, class U = T>
        struct is_nothrow_swappable
            : std::integral_constant<bool,
                                     is_swappable<T, U>::value && ((decltype(hpp_detail::swap_adl_tests::uses_std<T, U>(0))::value &&
                                                                    hpp_detail::swap_adl_tests::is_std_swap_noexcept<T>::value) ||
                                                                   (!decltype(hpp_detail::swap_adl_tests::uses_std<T, U>(0))::value &&
                                                                    hpp_detail::swap_adl_tests::is_adl_swap_noexcept<T, U>::value))>
        {};
#endif
#endif
        ...
        using enable_forward_value =
            hpp_detail::enable_if_t<std::is_constructible<T, U&&>::value && !std::is_same<hpp_detail::decay_t<U>, in_place_t>::value &&
                                    !std::is_same<optional<T>, hpp_detail::decay_t<U>>::value>;

        template<class T, class U, class Other>
        using enable_from_other =
            hpp_detail::enable_if_t<std::is_constructible<T, Other>::value && !std::is_constructible<T, optional<U>&>::value &&
        ...
        using enable_assign_forward =
            hpp_detail::enable_if_t<!std::is_same<optional<T>, hpp_detail::decay_t<U>>::value &&
                                    !hpp_detail::conjunction<std::is_scalar<T>, std::is_same<T, hpp_detail::decay_t<U>>>::value &&
                                    std::is_constructible<T, U>::value && std::is_assignable<T&, U>::value>;

        template<class T, class U, class Other>
        using enable_assign_from_other =
            hpp_detail::enable_if_t<std::is_constructible<T, Other>::value && std::is_assignable<T&, Other>::value &&
...
// move assignable
                     ...
                     private hpp_detail::optional_delete_assign_base<T>
    {
        ...
        static_assert(!std::is_same<hpp_detail::decay_t<T>, nullopt_t>::value, "instantiation of optional with nullopt_t is ill-formed");
...
// http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0826r0.html
        ...
        TL_OPTIONAL_11_CONSTEXPR auto and_then(F&& f) &
        {
            ...
            static_assert(hpp_detail::is_optional<result>::value, "F must return an optional");

            return has_value() ? hpp_detail::invoke(std::forward<F>(f), **this) : result(nullopt);
        }
        ...
        TL_OPTIONAL_11_CONSTEXPR auto and_then(F&& f) &&
        {
            ...
            return has_value() ? hpp_detail::invoke(std::forward<F>(f), std::move(**this)) : result(nullopt);
        }
        ...
        U map_or(F&& f, U&& u) &
        {
            return has_value() ? hpp_detail::invoke(std::forward<F>(f), **this) : std::forward<U>(u);
        }

        template<class F, class U>
        U map_or(F&& f, U&& u) &&
        {
            return has_value() ? hpp_detail::invoke(std::forward<F>(f), std::move(**this)) : std::forward<U>(u);
        }
        ...
        template<class... Args>
        constexpr explicit optional(hpp_detail::enable_if_t<std::is_constructible<T, Args...>::value, in_place_t>, Args&&... args) :
            base(in_place, std::forward<Args>(args)...)
        {}

        template<class U, class... Args>
        TL_OPTIONAL_11_CONSTEXPR explicit optional(
            hpp_detail::enable_if_t<std::is_constructible<T, std::initializer_list<U>&, Args&&...>::value, in_place_t>,
        ...
        template<class U,
                 hpp_detail::enable_from_other<T, U, const U&>*                    = nullptr,
        ...
        template<class U, hpp_detail::enable_from_other<T, U, U&&>* = nullptr, hpp_detail::enable_if_t<std::is_convertible<U&&, T>::value>* = nullptr>
        ...
        template<class U,
                 hpp_detail::enable_from_other<T, U, U&&>*                     = nullptr,
                 hpp_detail::enable_if_t<!std::is_convertible<U&&, T>::value>* = nullptr>
        ...
        /// Copies the value from `rhs` if there is one. Otherwise resets the stored
        /// value in `*this`.
        template<class U, hpp_detail::enable_assign_from_other<T, U, const U&>* = nullptr>
        ...
        template<class U, class... Args>
        hpp_detail::enable_if_t<std::is_constructible<T, std::initializer_list<U>&, Args&&...>::value, T&> emplace(std::initializer_list<U> il,
                                                                                                                   Args&&... args)
        {
            *this = nullopt;
            this->construct(il, std::forward<Args>(args)...);
        ...
        /// valueless.
        void swap(optional& rhs) noexcept(std::is_nothrow_move_constructible<T>::value&& hpp_detail::is_nothrow_swappable<T>::value)
        {
            using std::swap;
            if (has_value())
            {
    ...
    template<class T = hpp_detail::i_am_secret,
             class U,
             class Ret = hpp_detail::conditional_t<std::is_same<T, hpp_detail::i_am_secret>::value, hpp_detail::decay_t<U>, T>>
    ...
    namespace hpp_detail
    {
        ...
        template<class Opt,
                 class F,
                 class Ret                                           = decltype(hpp_detail::invoke(std::declval<F>(), *std::declval<Opt>())),
                 hpp_detail::enable_if_t<!std::is_void<Ret>::value>* = nullptr>
        constexpr auto optional_map_impl(Opt&& opt, F&& f)
        {
            return opt.has_value() ? hpp_detail::invoke(std::forward<F>(f), *std::forward<Opt>(opt)) : optional<Ret>(nullopt);
        }
...
// http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0826r0.html
        ...
        /// Carries out some operation on the stored object if there is one.
        template<class F>
        TL_OPTIONAL_11_CONSTEXPR decltype(hpp_detail::optional_map_impl(std::declval<optional&>(), std::declval<F&&>())) map(F&& f) &
        {
            return hpp_detail::optional_map_impl(*this, std::forward<F>(f));
        }
        ...
        template<class F>
        constexpr decltype(hpp_detail::optional_map_impl(std::declval<const optional&>(), std::declval<F&&>())) map(F&& f) const&
        {
            return hpp_detail::optional_map_impl(*this, std::forward<F>(f));
        }
        ...
        /// Carries out some operation on the stored object if there is one.
        template<class F>
        TL_OPTIONAL_11_CONSTEXPR decltype(hpp_detail::optional_map_impl(std::declval<optional&>(), std::declval<F&&>())) transform(F&& f) &
        {
            return hpp_detail::optional_map_impl(*this, std::forward<F>(f));
        }
        ...
        template<class F>
        constexpr decltype(hpp_detail::optional_map_impl(std::declval<const optional&>(), std::declval<F&&>())) transform(F&& f) const&
        {
            return hpp_detail::optional_map_impl(*this, std::forward<F>(f));
        }
        ...
        /// Constructs the stored value with `u`.
        template<class U = T, hpp_detail::enable_if_t<!hpp_detail::is_optional<hpp_detail::decay_t<U>>::value>* = nullptr>
