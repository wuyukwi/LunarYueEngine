...
namespace hpp
{
    ...
    public:
        ...
        constexpr std::uint_least32_t column() const noexcept { return column_offset_; }
    ...
    private:
        constexpr source_location(const char*          fileName,
            ...
            file_name_(fileName),
            function_name_(functionName), line_number_(lineNumber), column_offset_(columnOffset)
        {}
