...
namespace hpp
{
    ...
    namespace detail
    {
        ...
        constexpr inline auto invoke(T B::*f, D&& d, Args&&... args) noexcept(noexcept((std::forward<D>(d).*f)(std::forward<Args>(args)...))) ->
        ...
        constexpr inline auto invoke(T B::*f, R&& r, Args&&... args) noexcept(noexcept((r.get().*f)(std::forward<Args>(args)...))) ->
        ...
        constexpr inline auto invoke(T B::*f, P&& p, Args&&... args) noexcept(noexcept(((*std::forward<P>(p)).*f)(std::forward<Args>(args)...))) ->
        ...
        constexpr inline auto invoke(Callable&& c, Args&&... args) noexcept(noexcept(std::forward<Callable>(c)(std::forward<Args>(args)...)))
    ...
    constexpr inline auto invoke(F&& f, Args&&... args) noexcept(noexcept(detail::invoke(std::forward<F>(f), std::forward<Args>(args)...)))
