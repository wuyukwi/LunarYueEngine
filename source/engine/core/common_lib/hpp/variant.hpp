...
namespace STX_NAMESPACE_NAME
{
    namespace lib
    {
        ...
        inline namespace cpp14
        {
            ...
            {
                template<typename Lhs, typename Rhs>
                inline constexpr auto operator()(Lhs&& lhs, Rhs&& rhs) const RETURN(lib::forward<Lhs>(lhs) == lib::forward<Rhs>(rhs))
            };
#endif
...
#pragma warning(pop)
                ...
                inline constexpr auto invoke(T B::*pmv, D&& d) RETURN(lib::forward<D>(d).*pmv)
                    ...
                    inline constexpr auto invoke(Pmv pmv, Ptr&& ptr) RETURN((*lib::forward<Ptr>(ptr)).*pmv)
                        ...
                        inline constexpr auto invoke(T B::*pmf, D&& d, As&&... as) RETURN((lib::forward<D>(d).*pmf)(lib::forward<As>(as)...))
            ...
            namespace detail
            {
                ...
                struct is_invocable_r<void_t<invoke_result_t<F, Args...>>, R, F, Args...> : std::is_convertible<invoke_result_t<F, Args...>, R>
                {};
            ...
            namespace detail
            {
                ...
                namespace has_addressof_impl
                {
                    ...
                    {
                        return (std::is_class<T>::value || std::is_union<T>::value) && !std::is_same<decltype(&std::declval<T&>()), fail>::value;
                    }
...
#define DECLTYPE_AUTO_RETURN(...) \
    ...
    namespace detail
    {
        ...
        {
            return static_cast<int>(t) > static_cast<int>(result) ? common_trait_impl(t, ts...) : common_trait_impl(result, ts...);
        }
        ...
        struct traits
        {
            ...
            static constexpr Trait copy_assignable_trait =
                common_trait(copy_constructible_trait, trait<Ts, lib::is_trivially_copy_assignable, std::is_copy_assignable>()...);

            static constexpr Trait move_assignable_trait =
                common_trait(move_constructible_trait, trait<Ts, lib::is_trivially_move_assignable, std::is_move_assignable>()...);
        ...
        namespace access
        {
            ...
            struct recursive_union
            {
                ...
                {
                    template<typename V>
                    inline constexpr AUTO_REFREF operator()(V&& v) const AUTO_REFREF_RETURN(get_alt_impl<I - 1> {}(lib::forward<V>(v).tail_))
                };
                ...
                template<typename V, std::size_t I>
                inline static constexpr AUTO_REFREF get_alt(V&& v, in_place_index_t<I>) AUTO_REFREF_RETURN(get_alt_impl<I> {}(lib::forward<V>(v)))
#endif
            };
        ...
        namespace visitation
        {
            ...
            struct base
            {
                ...
                inline static constexpr const lib::remove_all_extents_t<T>& at(const lib::array<T, N>& elems, std::size_t i, Is... is) noexcept
                {
                ...
                inline static constexpr lib::array<lib::common_type_t<lib::decay_t<Fs>...>, sizeof...(Fs)> make_farray(Fs&&... fs)
                {
                ...
                struct dispatcher
                {
                    ...
                    struct impl
                    {
                        inline static constexpr DECLTYPE_AUTO dispatch(F f, Vs... vs)
                            DECLTYPE_AUTO_RETURN(lib::invoke(static_cast<F>(f), access::base::get_alt<Is>(static_cast<Vs>(vs))...))
                    };
                };
                                ...
                                inline static constexpr AUTO make_fdiagonal_impl(lib::index_sequence<Is...>)
                                    AUTO_RETURN(make_farray(make_fdiagonal_impl<Is, F, Vs...>()...))
                                        ...
                                        inline static constexpr /* auto * */ auto make_fdiagonal()
                                            -> decltype(make_fdiagonal_impl<F, V, Vs...>(lib::make_index_sequence<lib::decay_t<V>::size()> {}))
                {
                ...
                {
                    return make_fmatrix_impl<F, Vs...>(lib::index_sequence<> {}, lib::make_index_sequence<lib::decay_t<Vs>::size()> {}...);
                }
#else
                template<typename F, typename... Vs>
                struct make_fmatrix_impl
                {
                    ...
                    {
                        inline constexpr AUTO operator()() const AUTO_RETURN(make_farray(impl<lib::push_back_t<Is, Js>, Ls...> {}()...))
                    };
                };

                template<typename F, typename... Vs>
                inline static constexpr AUTO make_fmatrix()
                    AUTO_RETURN(typename make_fmatrix_impl<F, Vs...>::template impl<lib::index_sequence<>,
...
#pragma warning(pop)
            ...
            private:
                ...
                {
                    static_assert(lib::is_invocable<Visitor, Values...>::value, "`visit` requires the visitor to be exhaustive.");
...
#pragma warning(pop)
                ...
                struct value_visitor
                {
                    ...
                    inline constexpr DECLTYPE_AUTO operator()(Alts&&... alts) const DECLTYPE_AUTO_RETURN(
                        visit_exhaustive_visitor_check<Visitor, decltype((lib::forward<Alts>(alts).value))...> {}(lib::forward<Visitor>(visitor_),
                ...
                inline static constexpr AUTO make_value_visitor(Visitor&& visitor)
                    ...
                    : template<typename Visitor, typename... Vs>
                      inline static constexpr DECLTYPE_AUTO visit_alt_at(std::size_t index, Visitor&& visitor, Vs&&... vs)
                          DECLTYPE_AUTO_RETURN(alt::visit_alt_at(index, lib::forward<Visitor>(visitor), lib::forward<Vs>(vs).impl_...))
                      ...
                      visit_value_at(std::size_t index, Visitor&& visitor, Vs&&... vs)
                          DECLTYPE_AUTO_RETURN(visit_alt_at(index, make_value_visitor(lib::forward<Visitor>(visitor)), lib::forward<Vs>(vs)...))

                              template<typename Visitor, typename... Vs>
                              inline static constexpr DECLTYPE_AUTO visit_value(Visitor&& visitor, Vs&&... vs)
                                  DECLTYPE_AUTO_RETURN(visit_alt(make_value_visitor(lib::forward<Visitor>(visitor)), lib::forward<Vs>(vs)...))
            };
...
\
        template<typename... Args> \
        inline explicit constexpr recursive_union(in_place_index_t<0>, Args&&... args) : head_(in_place_t {}, lib::forward<Args>(args)...) \
        {} \
\
...
\
    protected: \
        ...
        MPARK_VARIANT_DESTRUCTOR(
            Trait::TriviallyAvailable, ~destructor() = default;, inline void destroy() noexcept { this->index_ = static_cast<index_t>(-1); });
            ...
            inline static void generic_construct(constructor& lhs, Rhs&& rhs)
            {
                ...
                if (!rhs.valueless_by_exception())
                {
                    visitation::alt::visit_alt_at(
                        ...
                        [](auto& lhs_alt, auto&& rhs_alt) { constructor::construct_alt(lhs_alt, lib::forward<decltype(rhs_alt)>(rhs_alt).value); }
#else
                        ctor {}
#endif
                        ,
...
\
        ...
        MPARK_VARIANT_MOVE_CONSTRUCTOR(
            Trait::Available, move_constructor(move_constructor&& that) noexcept(lib::all<std::is_nothrow_move_constructible<Ts>::value...>::value)
...
#pragma warning(pop)
                ...
                else
                {
                    ...
                    impl(lib::bool_constant < std::is_nothrow_constructible<T, Arg>::value || !std::is_nothrow_move_constructible<T>::value > {});
                }
            }
            ...
            inline void generic_assign(That&& that)
            {
                ...
                else
                {
                    visitation::alt::visit_alt_at(
                        that.index(),
#ifdef MPARK_GENERIC_LAMBDAS
                        [this](auto& this_alt, auto&& that_alt) { this->assign_alt(this_alt, lib::forward<decltype(that_alt)>(that_alt).value); }
#else
                        assigner<That> {this}
#endif
                        ,
...
\
        ...
        MPARK_VARIANT_MOVE_ASSIGNMENT(
            ...
            operator=(move_assignment&& that) noexcept(
                lib::all<(std::is_nothrow_move_constructible<Ts>::value && std::is_nothrow_move_assignable<Ts>::value)...>::value) {
...
\
        ...
        MPARK_VARIANT_COPY_ASSIGNMENT(Trait::TriviallyAvailable, copy_assignment& operator=(const copy_assignment& that) = default;);
...
#undef MPARK_VARIANT_COPY_ASSIGNMENT
    ...
    class variant
    {
        ...
        static_assert(lib::all<!std::is_array<Ts>::value...>::value, "variant can not have an array type as an alternative.");

        static_assert(lib::all<!std::is_reference<Ts>::value...>::value, "variant can not have a reference type as an alternative.");
    ...
    public:
        ...
        inline constexpr variant() noexcept(std::is_nothrow_default_constructible<Front>::value) : impl_(in_place_index_t<0> {})
        {}
        ...
        template<bool Dummy            = true,
                 lib::enable_if_t<lib::all<Dummy,
                                  ...
                                  int> = 0>
        inline void
        swap(variant& that) noexcept(lib::all<(std::is_nothrow_move_constructible<Ts>::value && lib::is_nothrow_swappable<Ts>::value)...>::value)
        {
    ...
    namespace detail
    {
        ...
        inline constexpr AUTO_REFREF generic_get(V&& v)
            AUTO_REFREF_RETURN(generic_get_impl<I, V>(holds_alternative<I>(v) ? 0 : (throw_bad_variant_access(), 0))(lib::forward<V>(v)))
    } // namespace detail
    ...
    template<std::size_t I, typename... Ts>
    inline constexpr lib::add_pointer_t<const variant_alternative_t<I, variant<Ts...>>> get_if(const variant<Ts...>* v) noexcept
    {
        return detail::generic_get_if<I>(v);
    }
...
#else
        return !lhs.valueless_by_exception() && (rhs.valueless_by_exception() || lhs.index() > rhs.index() ||
    ...
    inline constexpr bool operator<=(const variant<Ts...>& lhs, const variant<Ts...>& rhs)
    {
        ...
        return lhs.valueless_by_exception() ||
               (!rhs.valueless_by_exception() &&
                (lhs.index() < rhs.index() || (lhs.index() == rhs.index() && variant::visit_value_at(lhs.index(), less_equal {}, lhs, rhs))));
#endif
    }
    ...
    inline constexpr bool operator>=(const variant<Ts...>& lhs, const variant<Ts...>& rhs)
    {
        ...
        return rhs.valueless_by_exception() ||
               (!lhs.valueless_by_exception() &&
                (lhs.index() > rhs.index() || (lhs.index() == rhs.index() && variant::visit_value_at(lhs.index(), greater_equal {}, lhs, rhs))));
#endif
    }
    ...
    inline constexpr DECLTYPE_AUTO visit(Visitor&& visitor, Vs&&... vs)
        DECLTYPE_AUTO_RETURN((detail::all(lib::array<bool, sizeof...(Vs)> {{!vs.valueless_by_exception()...}}) ? (void)0 :
...
#endif
    template<typename... Ts>
    inline auto swap(variant<Ts...>& lhs, variant<Ts...>& rhs) noexcept(noexcept(lhs.swap(rhs))) -> decltype(lhs.swap(rhs))
    {
        lhs.swap(rhs);
    }
#if defined(__GNUC__) && !defined(__clang__)
...
namespace std
{
    ...
    struct hash<STX_NAMESPACE_NAME::detail::enabled_type<
        STX_NAMESPACE_NAME::variant<Ts...>,
        STX_NAMESPACE_NAME::lib::enable_if_t<
            STX_NAMESPACE_NAME::lib::all<STX_NAMESPACE_NAME::detail::hash::is_enabled<STX_NAMESPACE_NAME::lib::remove_const_t<Ts>>()...>::value>>>
    {
    ...
    private:
        ...
        static std::size_t hash_combine(std::size_t lhs, std::size_t rhs) { return lhs ^= rhs + 0x9e3779b9 + (lhs << 6) + (lhs >> 2); }
    };
