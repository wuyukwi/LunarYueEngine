...
namespace bits
{
    ...
    inline static auto get_low_nibble(unsigned char value) noexcept { return static_cast<unsigned char>(value & 0x0F); }

    inline static auto get_high_nibble(unsigned char value) noexcept { return static_cast<unsigned char>((value & 0xF0) >> 4); }
