...
#include "../common_lib/basetypes.hpp"
#include "../common_lib/hash.hpp"
...
namespace gfx
{
    ...
    public:
        ...
        std::shared_ptr<frame_buffer> get_fbo(const std::string& id, const std::vector<std::shared_ptr<texture>>& bind_textures);
