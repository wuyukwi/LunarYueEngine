...
namespace math
{
    ...
    public:
        ...
        /// </summary>
        //-------------------------------------------------------------------------
        inline bool contains_point(const vec3& point) const { return (glm::length2(position - point) < (radius * radius)); }
        ...
        /// </summary>
        //-----------------------------------------------------------------------------
        inline bool operator!=(const bsphere& bounds) const { return (position != bounds.position || radius != bounds.radius); }
