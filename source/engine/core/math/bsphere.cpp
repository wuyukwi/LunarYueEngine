...
#define BIGNUMBER 100000000.0 // Hundred million
    ...
    bsphere& bsphere::from_points(const char* point_buffer, unsigned int point_count, unsigned int point_stride)
    {
        ...
        vec3 xmin(big_number, big_number, big_number), xmax(-big_number, -big_number, -big_number), ymin(big_number, big_number, big_number),
            ymax(-big_number, -big_number, -big_number), zmin(big_number, big_number, big_number), zmax(-big_number, -big_number, -big_number), dia1,
            dia2;
