...
namespace math
{
    ...
    public:
        ...
        typename mat4_t::col_type const& operator[](typename mat4_t::length_type i) const { return get_matrix()[i]; }
    ...
    template<typename T, qualifier Q>
    inline transform_t<T, Q>::transform_t(const typename transform_t::mat4_t& m) : matrix_(m), dirty_(false)
    {
        update_components();
    }
    ...
    template<typename T, qualifier Q>
    inline typename transform_t<T, Q>::vec3_t transform_t<T, Q>::transform_coord(const typename transform_t::vec3_t& v) const
    {
        return transform_coord(v, *this);
    }

    template<typename T, qualifier Q>
    inline typename transform_t<T, Q>::vec3_t transform_t<T, Q>::inverse_transform_coord(const typename transform_t::vec3_t& v) const
    {
        return inverse_transform_coord(v, *this);
    }

    template<typename T, qualifier Q>
    inline typename transform_t<T, Q>::vec3_t transform_t<T, Q>::transform_normal(const typename transform_t::vec3_t& v) const
    {
        return transform_normal(v, *this);
    }

    template<typename T, qualifier Q>
    inline typename transform_t<T, Q>::vec3_t transform_t<T, Q>::inverse_transform_normal(const typename transform_t::vec3_t& v) const
    {
        return inverse_transform_normal(v, *this);
    }

    template<typename T, qualifier Q>
    inline typename transform_t<T, Q>::vec3_t transform_t<T, Q>::transform_coord(const typename transform_t::vec3_t& v, const transform_t& t)
    {
    ...
    template<typename T, qualifier Q>
    inline typename transform_t<T, Q>::vec3_t transform_t<T, Q>::inverse_transform_coord(const typename transform_t::vec3_t& v, const transform_t& t)
    {
        const mat4_t& m      = t.get_matrix();
    ...
    template<typename T, qualifier Q>
    inline typename transform_t<T, Q>::vec3_t transform_t<T, Q>::transform_normal(const typename transform_t::vec3_t& v, const transform_t& t)
    {
        const mat4_t& m      = t.get_matrix();
    ...
    template<typename T, qualifier Q>
    inline typename transform_t<T, Q>::vec3_t transform_t<T, Q>::inverse_transform_normal(const typename transform_t::vec3_t& v, const transform_t& t)
    {
        const mat4_t& m      = t.get_matrix();
        mat4_t        im     = glm::inverse(m);
