...
namespace fs
{
    ...
    auto syncer::get_on_created_callback(const std::string& ext) -> on_entry_created_t { return get_mapping(ext).on_entry_created; }

    auto syncer::get_on_modified_callback(const std::string& ext) -> on_entry_modified_t { return get_mapping(ext).on_entry_modified; }

    auto syncer::get_on_removed_callback(const std::string& ext) -> on_entry_removed_t { return get_mapping(ext).on_entry_removed; }

    auto syncer::get_on_renamed_callback(const std::string& ext) -> on_entry_renamed_t { return get_mapping(ext).on_entry_renamed; }
