...
namespace fs
{
    ...
    void show_in_graphical_env(const path& _path) { ShellExecuteA(nullptr, nullptr, _path.string().c_str(), nullptr, nullptr, SW_SHOWNORMAL); }
} // namespace fs
...
namespace fs
{
    auto executable_path(const char* argv0) -> path { return executable_path_fallback(argv0); }
