...
namespace fs
{
    ...
    public:
        ...
        /// </summary>
        //-----------------------------------------------------------------------------
        static auto watch(const fs::path& path, bool recursive, bool initial_list, clock_t::duration poll_interval, notify_callback callback)
            -> std::uint64_t;
    ...
    protected:
        ...
        /// </summary>
        //-----------------------------------------------------------------------------
        static auto watch_impl(const fs::path& path, bool recursive, bool initialList, clock_t::duration poll_interval, notify_callback& listCallback)
            -> std::uint64_t;
