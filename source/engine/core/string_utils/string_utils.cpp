...
namespace string_utils
{
    ...
    auto word_wrap(const std::string& value, std::string::size_type max_length, const std::string& line_padding /*= ""*/) -> std::string
    {
    ...
    auto random_string(std::string::size_type length) -> std::string
    {
        ...
        static const auto make_seeded_engine = []() {
            ...
            std::seed_seq              seed(std::initializer_list<typename random_generator_t::result_type> {
                static_cast<typename random_generator_t::result_type>(::std::chrono::system_clock::now().time_since_epoch().count()),
