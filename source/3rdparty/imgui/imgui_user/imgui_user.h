...
namespace ImGui
{
    IMGUI_API bool ImageButtonWithAspectAndTextDOWN(ImTextureID        texId,
    ...
    IMGUI_API bool    DragFloatNEx(const char*      labels[],
                                   float*           v,
                                   int              components,
                                   float            v_speed        = 1.0f,
                                   float            v_min          = 0.0f,
    ...
    IMGUI_API bool    DragIntNEx(const char*      labels[],
                                 int*             v,
                                 int              components,
                                 float            v_speed        = 1.0f,
                                 int              v_min          = 0,
                                 ...
                                 ImGuiSliderFlags flags          = 0);
    IMGUI_API bool    DragUIntNEx(const char*      labels[],
                                  unsigned int*    v,
                                  int              components,
                                  float            v_speed        = 1.0f,
    ...
    IMGUI_API bool    ToolbarButton(const char* id, ImTextureID texture, const char* tooltip, bool selected = false, bool enabled = true);
    IMGUI_API bool    ImageButtonEx(const char* id,
                                    ImTextureID texture,
                                    ImVec2      size     = ImVec2(24, 24),
                                    const char* tooltip  = nullptr,
                                    bool        selected = false,
                                    bool        enabled  = true);
    IMGUI_API int     ImageButtonWithAspectAndLabel(ImTextureID         texture,
                                                    ImVec2              texture_size,
                                                    ImVec2              size,
                                                    ImVec2              uv0,
                                                    ImVec2              uv1,
