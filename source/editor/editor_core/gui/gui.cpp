...
namespace gui
{
    ...
    int ImageButtonWithAspectAndLabel(texture_info        info,
                                      const ImVec2&       texture_size,
                                      const ImVec2&       size,
                                      const ImVec2&       _uv0,
                                      const ImVec2&       _uv1,
                                      ...
                                      ImGuiInputTextFlags flags /*= 0*/)
    {
        ...
        return ImGui::ImageButtonWithAspectAndLabel(
            info.texture.get(), texture_size, size, uv0, uv1, selected, edit_label, label, buf, buf_size, flags);
    }

    void CleanupTextures() { s_textures.clear(); }

    bool ImageButtonWithAspectAndTextDOWN(texture_info       info,
                                          ...
                                          const ImVec4&      tint_col)
    {
        ...
        return ImGui::ImageButtonWithAspectAndTextDOWN(info.texture.get(), name, texture_size, image_size, uv0, uv1, frame_padding, bg_col, tint_col);
    }
} // namespace gui
