...
namespace imguidock
{
    ...
    struct dock
    {
        void initialize(const std::string& dtitle, bool close_btn, const ImVec2& min_sz, std::function<void(const ImVec2&)> ddrawFunction);
    ...
    protected:
        slot          render_dock_slot_preview(std::uint32_t id, const ImVec2& mousePos, const ImVec2& cPos, const ImVec2& cSize);
