...
bool inspector_asset_handle_texture::inspect(rttr::variant& var, bool read_only, const meta_getter& get_metadata)
{
    ...
    if (gui::BeginTabBar("asset_handle_texture", ImGuiTabBarFlags_NoCloseWithMiddleMouseButton | ImGuiTabBarFlags_FittingPolicyScroll))
    {
...
bool inspector_asset_handle_material::inspect(rttr::variant& var, bool read_only, const meta_getter& get_metadata)
{
...
bool inspector_asset_handle_mesh::inspect(rttr::variant& var, bool read_only, const meta_getter& get_metadata)
{
    ...
    if (gui::BeginTabBar("asset_handle_mesh", ImGuiTabBarFlags_FittingPolicyResizeDown | ImGuiTabBarFlags_NoCloseWithMiddleMouseButton))
    {
...
bool inspector_asset_handle_sound::inspect(rttr::variant& var, bool read_only, const meta_getter& get_metadata)
{
    ...
    if (gui::BeginTabBar("asset_handle_sound", ImGuiTabBarFlags_FittingPolicyResizeDown | ImGuiTabBarFlags_NoCloseWithMiddleMouseButton))
    {
        if (gui::BeginTabItem("\tInfo\t"))
        {
            if (data)
...
bool inspector_asset_handle_prefab::inspect(rttr::variant& var, bool read_only, const meta_getter& get_metadata)
{
